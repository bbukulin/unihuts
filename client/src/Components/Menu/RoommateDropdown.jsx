...
function RoommateDropdown({ id }) {
	const { setEditRoommate, deleteRoommate } = useAppContext();
	...
	return (
		<>
			...
			<Menu as="div" className="relative inline-block text-left">
				<div>
					<Menu.Button className="inline-flex w-full justify-center rounded-md border-2 border-neutral-200 bg-white px-2 py-1 text-xs font-medium text-gray-700 transition duration-300 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2 focus:ring-offset-gray-100">
...
export default RoommateDropdown;
