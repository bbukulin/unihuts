...
const TextInputWithNote = ({ label, note, ...props }) => {
				...
				<div>
					...
					<div className="mt-1">
						<input
							{...field}
							{...props}
							className="block w-full rounded-md border-2 border-neutral-200 bg-neutral-50 px-3 py-2 text-neutral-800 placeholder-neutral-300 shadow-sm transition duration-500 hover:border-primary-400 hover:shadow-md focus:border-primary-500 focus:outline-none focus:ring-primary-500 sm:text-sm"
						/>
					</div>
